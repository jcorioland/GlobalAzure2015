...
{
    public class MediaServicesWrapper
    {
        private readonly CloudMediaContext _cloudMediaContext;
        private readonly CloudStorageAccount _cloudStorageAccount;

        public MediaServicesWrapper(string mediaServiceName, string mediaServiceKey, string storageConnectionString)
        {
        ...
        public async Task<IJob> CreateJobAsync(IAsset mediaServiceAsset)
        {
            // create the job
